namespace ROOT.CIMV2.Win32 {
    ...
    // As funções ShouldSerialize<PropertyName> são funções utilizadas pela janela de propriedades de VS para verificar se é necessário serializar uma propriedade em particular. Estas funções são adicionadas para todas as propriedades ValueType (propriedades do tipo Int32, BOOL, etc., que não é possível definir com o valor Null). Estas funções utilizam a função Is<PropertyName>Null. Estas funções são igualmente utilizadas na implementação de TypeConverter para que as propriedades possam verificar se uma propriedade tem o valor NULL, para que seja possível apresentar um valor vazio na janela de propriedades caso sejam utilizadas as opções de arrastar e largar no Visual Studio.
    // As funções Is<PropertyName>Null() são utilizadas para verificar se uma propriedade é NULL.
    // As funções Reset<PropertyName> são adicionadas às propriedades Read/Write que permitem o valor Null. Estas funções são utilizadas pelo estruturador de VS na janela de propriedades para definir uma propriedade com o valor NULL.
    ...
    // As funções de conversão de data e hora ToDateTime e ToDmtfDateTime são adicionadas à classe para converter a data e hora DMTF em System.DateTime e vice-versa.
    // Foi gerada uma classe Early Bound para a classe WMI.Win32_NetworkAdapter
    public class NetworkAdapter : System.ComponentModel.Component {
        
        // Propriedade privada para conter o espaço de nomes WMI em que a classe reside.
        private static string CreatedWmiNamespace = "root\\CimV2";
        
        // Propriedade privada para conter o nome da classe WMI que criou esta classe.
        private static string CreatedClassName = "Win32_NetworkAdapter";
        
        // Variável de membro privado para conter o ManagementScope utilizado pelos diferentes métodos.
        ...
        // Variável de membro para armazenar o comportamento de consolidação automática da classe.
        private bool AutoCommitProp;
        
        // Variável privada para conter a propriedade incorporada que representa a instância.
        private System.Management.ManagementBaseObject embeddedObj;
        
        // O objecto WMI actual utilizado
        private System.Management.ManagementBaseObject curObj;
        
        // Sinalizador para indicar se a instância é um objecto incorporado.
        ...
        public NetworkAdapter(System.Management.ManagementObject theObject) {
            ...
            if ((CheckIfProperClass(theObject) == true)) {
                ...
                throw new System.ArgumentException("O nome da classe não corresponde.");
            }
        }
        ...
        // A propriedade devolve o espaço de nomes da classe WMI.
        [Browsable(true)]
        ...
        // Propriedade para mostrar o comportamento de consolidação do objecto WMI. Se a definição for true, o objecto WMI será automaticamente guardado após cada modificação de propriedade (ou seja, Put() é chamado depois de uma propriedade ter sido modificada).
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        // Propriedade pública de âmbito estático utilizada pelos diferentes métodos.
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
...
.. - Other - For integer values other than those listed above, refer to Win32 error code documentation.")]
        ...
        // Converte uma data/hora determinada em formato DMTF no objecto System.DateTime.
        ...
        // Converte um objecto System.DateTime determinado no formato de data/hora DMTF.
        ...
        // TypeConverter para processar valores null de propriedades ValueType
        ...
        // Classe incorporada para representar as propriedades System de WMI.
